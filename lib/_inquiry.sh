...
get_link_git() {
  ...
  print_banner
  printf "${WHITE} 💻 Insira o link do GITHUB do seu Ultravita que deseja instalar:${GRAY_LIGHT}"
  printf "\n\n"
  read -p "> " link_git
}
...
inquiry_options() {
  ...
  print_banner
  printf "${WHITE} 💻 Bem vindo(a) ao Gerenciador Ultravita, selecione abaixo a proxima ação!${GRAY_LIGHT}"
  printf "\n\n"
  printf "   [0] Instalar Ultravita\n"
  printf "   [1] Atualizar Ultravita\n"
  printf "   [2] Deletar Ultravita\n"
  printf "   [3] Bloquear Ultravita\n"
  printf "   [4] Desbloquear Ultravita\n"
  printf "   [5] Alter. dominio Ultravita\n"
  printf "\n"
  read -p "> " option
